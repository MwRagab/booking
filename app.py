...
MULTI_SLOT = {
    "محمود قاسم": [{"slot": "الجمعة 08:00 (في انتظار المنهج)", "max": 90}, {"slot": "السبت 04:00 (في انتظار المنهج)", "max": 200}],
    "عبدالمجيد": [{"slot": "الإثنين 05:00 (البداية 08/17)", "max": 65}, {"slot": "الأحد 03:00 (البداية 08/16)", "max": 145}],
    "أحمد ربوشة": [{"slot": "الجمعة 01:30 (في انتظار المنهج)", "max": 128}, {"slot": "الجمعة 03:30 (في انتظار المنهج)", "max": 128}, {"slot": "السبت 12:30 (في انتظار المنهج)", "max": 128}],
    "أسامة رفعت": [{"slot": "الثلاثاء 05:00 (البداية 08/18)", "max": 94}, {"slot": "الخميس 03:00 (البداية 08/20)", "max": 94}],
    "سامي سمير": [{"slot": "الأربعاء 03:00 (البداية 08/26)", "max": 117}, {"slot": "الأحد 05:00 (البداية 08/30)", "max": 117}]
}
